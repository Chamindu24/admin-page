...
export async function PATCH(req: Request) {
  ...
  <div style="padding: 25px; color: #555;">
    ...
    <div style="border: 1px solid #E24A4A; padding: 15px; border-radius: 8px; background-color: #fff5f5; margin: 20px 0;">
      <p style="font-size: 16px; color: #E24A4A; margin: 0;">
       <strong>Action Required:</strong> Please check if your seat is correctly booked or if you uploaded the correct recipient.
      </p>
    </div>

    <p style="font-size: 14px; color: #888; margin: 20px 0;">
If you have any issues, feel free to <strong>
  <a href="tel:+94766863345" style="color: #3B82F6; text-decoration: none;"> 
    Call us at +94 76 686 3345
  </a>
</strong>.
    </p>
  </div>
